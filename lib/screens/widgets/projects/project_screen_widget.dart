                    ...
                    children: [
                      Obx(() {
                        ...
                        if (controller.filteredProjects.isEmpty) {
                          return Padding(
                            ...
                            child: AppTextHeading(
                                text: "No projects found based on your search",
                                fontSize: 16),
                          );
                        }
                        ...
                        return ListView.separated(
                          ...
                          final int remainingBudget = project.remainingBudget;
                          final spentBudget =
                              totalBudgetAllocated - remainingBudget;
                          final String status = project.status;
                          final String projectId = project.projectId;
                          final List<String> employeeIds = project.employeeIds;

                          final progressValue = AppUtils.calculatePercentage(
                            spentBudget,
                          ...
                          return AppCardWidget(
                            cardWidget: Column(
                              ...
                              children: [
                                projectCardHeader(projectName, context, status),
                                AppTextBody(text: projectDiscription),
                                AppTextBody(text: projectId, fontSize: 14),
